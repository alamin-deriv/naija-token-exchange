...
describe("Exchange", () => {
  let deployer, feeAccount, exchange, accounts, token1, token2, user1, user2;
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy("Arewa Token", "AREWA", "1000000");
    token2 = await Token.deploy("e-Naira", "E-NAIRA", "1000000");
